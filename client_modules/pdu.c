...
/*
 * Funcions encarregades de imprimir les pdus
 */
...
/*
 * Permet imprimir els dos tipus de pdu en una mateixa funcio
 * Exesteix mes que res perque volia experimentar amb els punters
 */
...
/*
 * Funcions wrapper per enviar pdus, a part de enviar tambe imprimeixen si en debug
 */
...
/*
 * Generadors de pdus, permeten fer-ho tot en una linia
 */
